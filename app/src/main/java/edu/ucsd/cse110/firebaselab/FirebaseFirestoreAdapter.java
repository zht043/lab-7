...
public class FirebaseFirestoreAdapter implements ChatService {
    ...
    public FirebaseFirestoreAdapter(String collectionKey, String chatId, String messagesKey, String fromKey, String textKey, String timeStampKey, FirebaseFirestore firebaseFirestore) {
        this.fromKey = fromKey;
        this.textKey = textKey;
        this.timeStampKey = timeStampKey;
        this.chat = firebaseFirestore
                .collection(collectionKey)
                .document(chatId)
                .collection(messagesKey);
    }
